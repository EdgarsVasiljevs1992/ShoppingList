...
//  ShoppingList
//
//  Created by edgars.vasiljevs on 17/11/2021.
//
...
//    var shopping = [String]()
    ...
    @IBAction func addNewItem(_ sender: Any) {
        ...
        let addActionButton = UIAlertAction(title: "Add", style: .default) { action in
            ...
            shop.setValue(textFieldCount.text, forKey: "count")
...
//        cell.textLabel?.text = shopping[indexPath.row]
        ...
        cell.detailTextLabel?.text = "Description: \(shop.value(forKey: "count") ?? "")"
